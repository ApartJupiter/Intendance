(function (h) {
    ...
    I = function (a, b) {
      for (
        var d = H(b),
          ...
          g = b.fieldSeparator,
          k = RegExp(e, "g"),
          i = b.escapeChar !== r ? b.escapeChar : "\\",
          h = function (a) {
            for (var c = "", b = 0, d = a.length; b < d; b++)
              0 < b && (c += g),
                (c += e ? e + ("" + a[b]).replace(k, i + e) + e : a[b]);
            return c;
          },
          f = b.header ? h(c.header) + d : "",
          l = b.footer && c.footer ? d + h(c.footer) : "",
          j = [],
          m = 0,
          o = c.body.length;
        m < o;
  ...
  p.ext.buttons.copyHtml5 = {
    ...
    action: function (a, b, d, c) {
      ...
      c = h("<textarea readonly/>").val(i).appendTo(d);
      ...
      b.buttons.info(b.i18n("buttons.copyTitle", "Copy to clipboard"), f, 0);
      c[0].focus();
      c[0].select();
  ...
  p.ext.buttons.excelHtml5 = {
    ...
    action: function (a, b, d, c) {
      ...
      c.header && (m(j.header, g), h("row:last c", i).attr("s", "2"));
      d = g;
      k = 0;
      ...
      m = a.xl["workbook.xml"];
      h("sheets sheet", m).attr("name", G(c));
      c.autoFilter &&
        ...
        h("definedNames", m).append(
          o(m, "definedName", {
            ...
            text: G(c) + "!$A$" + d + ":" + w(j.header.length - 1) + k,
          })
        ));
